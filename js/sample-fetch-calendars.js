...
import { firestore, doc, getDoc, setDoc } from "./firebaseConfig.js";
...
/**
 * Fetches calendars for the given user.
 * @param {Object} user - The current user object (e.g., from Firebase Auth).
 * @returns {Promise<Array>} - The list of calendars owned by the user.
 */
